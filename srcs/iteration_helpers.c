...
/*   Updated: 2019/04/17 16:51:36 by otimofie         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void iteration_2(int last_row_words_quantity, t_input *end, t_input *head_start)
{
...
t_input *iteration_3(int last_row_words_quantity, int words_per_line, int quantity_of_words)
{
	t_input	*previous_to_last_row;
	int		j;

	j = 0;
	previous_to_last_row = last_row_start_not(words_per_line, quantity_of_words);
...
void if_mod_not_equals_zero(int words_per_line, int quantity_of_words)
{
	...
	end = iteration_3(last_row_words_quantity, words_per_line, quantity_of_words);
